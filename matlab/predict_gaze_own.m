function [x_predict,y_predict,hm_results,ims] = predict_gaze_own(img,e,sal)
   ...
   if(bottom_x<1)
    ...
    %}
    image_mean_cell = {'places_mean_resize.mat','imagenet_mean_resize.mat','imagenet_mean_resize.mat','imagenet_mean_resize.mat'};

    input_dim_all = [1 3 227 227 1 3 227 227 1 169 1 1 1 1 13 13]; %last 4 added
